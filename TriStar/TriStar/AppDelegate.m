...
- (void)setFormListVIewAsRootController{
...
//    self.viewController = [[ViewController alloc] initWithNibName:@"ViewController" bundle:nil];
    ...
    SplashViewController *viewController = [[SplashViewController alloc] initWithNibName:@"SplashViewController" bundle:nil];
...
//    self.window.rootViewController = self.viewController;
    [self setFormListVIewAsRootController];
